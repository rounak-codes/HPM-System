...
@WebServlet("/docUpdateAppointmentServlet")
public class docUpdateAppointmentsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("doctorManageAppointments.jsp"); // Redirect to dashboard after updating
        } catch (Exception e) {
            e.printStackTrace();
